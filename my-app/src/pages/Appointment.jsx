        ...
        <div className='p-4'>
            ...
            <div className='flex flex-col sm:flex-row gap-6 bg-white rounded-lg shadow-md p-6'>
                <div className="flex-shrink-0 sm:w-1/3">
                    <img className='bg-primary w-full rounded-lg' src={docInfo.image} alt="" />
                </div>
                <div className='flex-1'>
                    {/* -------------DocInfo: name,degree,exp-------------- */}
                    <p className='flex items-center gap-2 text-gray-900 text-xl font-medium'>
                        {docInfo.name} 
                    ...
                    <div className="text-left">
                        <p className="flex items-center gap-1 text-gray-900 text-lg font-medium mt-3">
                            About<img src={assets.info_icon} alt=""/></p>
                        <p className="text-base text-gray-500 max-w-[700px] mt-1">{docInfo.about}</p>
                    </div>
                    <p className="text-left text-gray-500 font-medium mt-4">
